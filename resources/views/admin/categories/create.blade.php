...
@section('content')
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 tracking-tight">Nova Categoria</h1>
            <p class="mt-1 text-sm text-gray-500">Crie uma nova categoria para organizar seus produtos.</p>
        </div>
